...
/***/ function(module, exports, __webpack_require__) {
	...
	function chain() {
	  ...
	  return function (payload) {
	    var wrapedFns = fns.map(function (fn) {
	      return function callee$3$0(arg) {
	        return regeneratorRuntime.async(function callee$3$0$(context$4$0) {
	          while (1) switch (context$4$0.prev = context$4$0.next) {
	            case 0:
	              context$4$0.next = 2;
	              return regeneratorRuntime.awrap(Promise.resolve(arg));

	            case 2:
	              arg = context$4$0.sent;
	            ...
	            case 5:
	              context$4$0.next = 7;
	              return regeneratorRuntime.awrap(fn(payload));
	    ...
	    return compose.apply(undefined, _toConsumableArray(wrapedFns))(payload);
	  };
	}
	...
	var close = chain(compositeSaveStateChanged, backendLogicSaveStateChanged, navigatorSaveStateChanged);
